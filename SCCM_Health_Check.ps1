...
Write-Host "File Name	: ConfigMgr_Weekly_Servers_Health_Check_Reports"              				-foregroundcolor "Green"                                                                                         
Write-Host "Purpose 	: ConfigMgr_Weekly_Servers_Health_Check_Reports to sent an email" 			-foregroundcolor "Green"                        
Write-Host "*******************************************************************************" -foregroundcolor "Green"
...
<Settings>
	...
	<SCCMSettings>
		...
		<OutputFileName>ConfigMgr_Weekly_Servers_Health_Check_Reports</OutputFileName>
...
#****************************************************************************************
$Report = "$OutputPath\ConfigMgr_Weekly_Servers_Health_Check_Reports.html"
$CSVReport = "$OutputPath\ConfigMgr_Weekly_Servers_Health_Check_Reports.CSV"
$Logfile = "$OutputPath\ConfigMgr_Weekly_Servers_Health_Check_Reports.log"
#****************************************** Start ***********************************************
...
$ReportTitle = "$ProjectName - ConfigMgr Weekly Servers Health Check Reports - $(get-date -Format F)"
#************************************************************************************************************************
Function Get-WeeklyHTMLReport
{
