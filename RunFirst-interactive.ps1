...
do{
    do{
        $Company = InputBox -title "Company" -body "Enter Company/Organization name" -default " "
    }while($Company -eq " ")
...
do{
    do{
        $DBServer = InputBox -title "Server" -body "Enter SCCM DB Server name" -default " "
    }while($DBServer -eq " ")
...
do{
    do{
        $SiteCode = InputBox -title "SiteCode" -body "Enter SCCM Site Code" -default " "
    }while($SiteCode -eq " ")
...
do{
    do{
        $DB = InputBox -title "DataBase" -body "Enter SCCM Database name" -default " "
    }while($DB -eq " ")
    IF($DB -eq ""){Return}
...
do{
    do{
        $siteServer = InputBox -title "Site Server" -body "Enter Primary SCCM Site Server" -default " "
    }while($siteServer -eq " ")
...
AckBox -type Information -button OKCancel -title "SCCM Server List" -body "Next you will be prompted to select a text file with all SCCM Servers and DPs listed, please list the servers comma seperated"
...
$config|Out-File $path"\"ConfigFile.xml
