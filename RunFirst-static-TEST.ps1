...
$configs = Import-Csv "C:\Users\tankc\source\repos\SCCM_Health_Check\configs.csv"
write-host $configs
...
$serverlist = Import-Csv "C:\Users\tankc\source\repos\SCCM_Health_Check\sccmservrolelist.csv"|select -ExpandProperty "Server Name" -Unique
...
#$serverlist = MultipleSelectionBox -listboxtype none -inputarray $serverfilelist -prompt "Please Verify the List looks Correct"
